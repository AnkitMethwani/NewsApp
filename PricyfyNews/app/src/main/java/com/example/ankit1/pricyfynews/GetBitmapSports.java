 ...
 */
public class GetBitmapSports extends AsyncTask<Void,Void,Void> {

    private Context context;
    private String[] urls;
    private ProgressDialog loading;
    private Sports mainActivity;

    public GetBitmapSports(Context context, Sports mainActivity, String[] urls){
